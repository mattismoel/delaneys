...
import {
  employee,
  type ArchiveEmployeeHandler,
  type DeleteEmployeeHandler,
  type Employee,
  type EmployeeProvider,
  type GetEmployeeByIDHandler,
  type GetEmployeesHandler,
  type CreateEmployeeHandler,
  type MoveHandler,
  type RestoreEmployeeHandler,
  type UpdateEmployeeHandler,
} from "$lib/features/employees/employee";
import { createFileUrl } from "./pocketbase";
import { PUBLIC_API_BASE_URL } from "$env/static/public";

export const pocketBaseEmployeeProvider = (
  pb: PocketBase,
): EmployeeProvider => {
